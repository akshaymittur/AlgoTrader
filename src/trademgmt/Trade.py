...
class Trade:
    def __init__(self, tradingSymbol=None):
        ...
        # True means place the entry order with Market Order Type
        self.placeMarketOrder = False
        # Can be strategy specific. Some can square off at 15:00:00 some can at 15:15:00 etc.
        ...
        # Set this timestamp to strategy timestamp if you are not sure what to set
        self.timestamp = None
